...
class TrainOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--EpochNum', help='max epoch num', type=int, default=50) 
        ...
        parser.add_argument('--SaveCheckInterval', help='checkpoint saving epoch interval', type=int, default=5)
        ##
        parser.add_argument('--DataRoot', help='DataPath', type=str, default='./dataset/train/')
        parser.add_argument('--ModelRoot', help='Path for saving model', type=str, default='./trained_models/memae/memae_ipad.pth')
        ##
